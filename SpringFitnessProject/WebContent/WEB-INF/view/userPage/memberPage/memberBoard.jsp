...
<c:if test="${notPaid != null }">
	<script>
	// Unpaid user should not be allowed to use this service
...
<div class="body-box">
	<jsp:include page="/resource/pages/memberMenuBar.jsp" />
...
<script src="/SpringFitnessProject/resource/js/member.board.js"></script>
